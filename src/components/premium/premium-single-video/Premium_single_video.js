  ...
  return (
    <div>
      ...
      <div className="set-premium-subscription-card"> 
        <Subscription_card
          subscriptionTitle="&#8377;199/month"
          subscriptionDesc="Unlimited access to the greatest real-life entertainment plus exclusives and originals"
        />
        <Subscription_card
          subscriptionTitle="&#8377;399/year"
          subscriptionDesc="Unlimited access to all that the monthly plan has to offer with"
          subscriptionExtra="₹1000 in savings"
        />
      </div>
